...
export interface AgentFormFieldsProps {
  ...
  siblings: Agent[];
  running: boolean;
  /** Quando passa a `true` (diálogo aberto, aba mostrada), o formulário recomeça do agente. */
  active: boolean;
  ...
  /** Sem ele, não há "Cancelar" (a aba Config do inspetor fica sempre aberta). */
  onCancel?: () => void;
  /** Coluna única, para os 320px do inspetor. */
  compact?: boolean;
}
...
export function AgentFormFields({
  ...
  return (
    ...
    >
      ...
      <div className={cn('flex gap-2', compact ? 'flex-col items-stretch' : 'items-end')}>
