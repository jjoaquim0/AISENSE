...
[03 — Stack](../03-stack.md#orçamento-de-performance-metas-verificáveis-na-fase-7) ·
[09 — Telas](../09-telas-e-fluxos.md)

## Tarefas

### [ ] F07-01 — Auditoria de performance
Medir todas as métricas do orçamento de [03 — Stack](../03-stack.md#orçamento-de-performance-metas-verificáveis-na-fase-7)
...
### [ ] F07-02 — Auditoria de acessibilidade
...
### [ ] F07-03 — Estados vazios, carregamento e erro
...
### [ ] F07-07 — Notificações do sistema
...
### [ ] F07-08 — Testes E2E
Playwright cobrindo os 5 fluxos críticos de [09 — Telas](../09-telas-e-fluxos.md#fluxos-críticos-e2e-da-fase-7).
**Aceite:** a suíte roda no CI dos 3 SOs de forma estável (sem flake) por 10 execuções seguidas.

### [ ] F07-09 — Polimento visual final
...
| Polimento virar buraco sem fundo | Timebox: a lista de F07-09 é fechada no início da fase e não cresce durante ela |
